...
@section('content')
  <div class="container">
    <div class="col-md-6 mt-5">
          <h1>About Us</h1>
         <form method="POST" action="{{url('/aboutcreated')}}" enctype="multipart/form-data">
          @csrf
     ...
     <table class="table table-bordered" id="table">
      ...
      <tr>
        ...
        <td>{{($about->heading)}}</td>
        <td>{{($about->content)}}</td>
        <td><img src="{{asset('storage/'.$about->image)}}" alt="" id="imgc"></td>
        <td>
          <a href="{{route('dltabt',['id' => $about->id ])}}">
